...
def get_articles_via_rss(status_placeholder):
    ...
    for url in RSS_FEED_URLS:
        try:
            ...
            # Estrae il nome della fonte in modo robusto
...
# run_news_collection chiama solo l'RSS, la parte Search è nel Prompt/Gemini
...
def summarize_with_gemini(rss_articles, search_queries, status_placeholder):
    ...
    * **FORMATO:** Inizia con una breve introduzione e concludi con una chiusura. NON USARE titoli Markdown o elenchi puntati. Il testo deve essere narrativo e fluido.
    ...
    # Definisce il tool di ricerca in un formato compatibile con pydantic
...
Il sistema usa la logica **Ibrida Corretta**: legge i feed RSS (base) e chiede a **Gemini** di eseguire ricerche mirate (`site:`) per integrare la copertura sui domini da te scelti.
""")
...
if st.button("▶️ Genera il Radiogiornale Quotidiano", type="primary"):
    ...
    # Passiamo le query pre-calcolate a Gemini
